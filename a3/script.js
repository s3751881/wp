...
let movies_syn = {
    'synopsisACT': {
        ...
        rating: 'M',
        movieday: [ 'Wednesday: 9pm', 'Thursday: 9pm', 'Friday 9pm', 'Saturday: 6pm ', 'Sunday: 6pm'],
        hour:['-', '-', '21:00', '21:00', '21:00', '18:00', '18:00'],
    ...
    'synopsisAHF': {
        ...
        rating: 'MA15+',
        movieday:['Wednesday','Thursday','Saturday','Sunday'],
        hour: ['-', '-', '12:00', '12:00', '12:00', '21:00', '21:00'],
    ...
    'synopsisRMC': {
        ...
        rating: 'M',
        movieday:['Monday','Tuesday','Saturday','Sunday'],
        hour: ['18:00', '18:00', '-', '-', '-', '15:00', '15:00'],
    ...
    'synopsisANM': {
        name: 'Dumbo',
        rating: 'PG',
        movieday:['Monday','Tuesday','Wednesday','Thursday','Saturday','Sunday'],
        hour: ['12:00', '12:00', '18:00', '18:00', '18:00', '12:00', '12:00'],
...
function showContent(event){
    ...
    createDetailContainer(movie_showtime);
    console.log('clicked')
}
...
//     return button
// }
const createTimeButton = (hour,day,index) => {
    let button = document.createElement('Button');
    button.setAttribute('class', 'btn btn-secondary movie_hour');
    button.setAttribute('style', 'margin: 2% 2% 2% 0;');
    button.setAttribute('id', 'movie_hour_' + index);
    button.onclick = (e) => e.preventDefault();
//    create span day 
    let information_day= document.createElement('SPAN');
    information_day.innerText = day;
    information_day.setAttribute('class', 'day');
    let information_hour = document.createElement('SPAN');
    information_hour.innerText = hour;
    information_hour.setAttribute('class','hour')
    button.appendChild(information_day,information_hour)
// hour   
    return button
}
...
const createDetailContainer = (time)=>{
    ...
    detailContainer.setAttribute('style', 'color:black; display:block');
    detailContainer.setAttribute('id', 'timetable');
    for (let item1,item2 of time) {
        const detailButton = createTimeButton(item1,item2,index);
        index++;
        detailContainer.append(detailButton);
    }
}
